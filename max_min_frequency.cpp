...
struct MinHeap
{
    ...
    unsigned count; // indicates the number of slots filled.
...
// in min heap
void minHeapify( MinHeap* minHeap, unsigned idx )
{
    unsigned left, right, smallest;
...
void printKMostFreq( fstream& file, int k )
{
